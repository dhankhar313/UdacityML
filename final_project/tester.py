...
def dump_classifier_and_data(clf, dataset, feature_list):
    ...
    with open(FEATURE_LIST_FILENAME, "wb") as feature_list_outfile:
        pickle.dump(feature_list, feature_list_outfile)
...
def load_classifier_and_data():
    ...
    with open(FEATURE_LIST_FILENAME, "rb") as feature_list_infile:
        feature_list = pickle.load(feature_list_infile)
